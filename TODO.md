...
- [ ] Размер лимита БД: нужен ли ротационный механизм (хранить N последних сессий)?
- [ ] Конфиденциальность: шифровать SQLite-файл на диске?
- [ ] MemoryExtractor  использовать эвристики или вызов LLM для извлечения фактов?
- [ ] Интеграция с существующим MCP memory или отдельное хранилище?
- [ ] UI: выводить предупреждение при `/memory clear` (подтверждение)?
