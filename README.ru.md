...
| `Esc` ×2 | принудительное прерывание |
| `Shift+Tab` | переключить режим Ask / Auto |
| `F2` | раскрыть / свернуть блок рассуждений |
| `↑` / `↓` | прокрутка истории |
| `Ctrl+C` | выход |
...
| команда | действие |
|---|---|
| `/auto` | переключиться в режим Auto |
| `/ask` | переключиться в режим Ask |
| `/reset` | сбросить сессию и отменить ожидающие подтверждения |
| `/thinking` | включить / отключить рассуждения модели |
